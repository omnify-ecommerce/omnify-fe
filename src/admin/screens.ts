...
export const SCREENS: Record<ScreenKey, ScreenDef> = {
  categories: {
    ...
    rows: [
      row({
        ...
        meta: 'Điện thoại & Phụ kiện › Điện thoại di động · MÃ DM-1042',
        col2: 'Cấp 2',
        col3: '428',
        ch: ['ok', 'ok', 'ok'],
        state: 'ready',
      ...
      row({
        name: 'Ốp lưng & Bao da',
        meta: 'Điện thoại & Phụ kiện › Ốp lưng & Bao da · MÃ DM-1043',
        col2: 'Cấp 2',
        col3: '1.126',
        ch: ['ok', 'ok', 'partial'],
        state: 'partial',
      ...
      row({
        name: 'Áo thun nam',
        meta: 'Thời trang nam › Áo › Áo thun nam · MÃ DM-2211',
        col2: 'Cấp 3',
        col3: '864',
        ch: ['ok', 'broken', 'none'],
        state: 'error',
        ...
        updated: 'Hôm qua',
        warning:
          'Lazada đã gộp danh mục mục tiêu (ID 18294) vào “Áo nam”. Ánh xạ bị hỏng — 864 SKU đang tạm ngừng đăng.',
      }),
      row({
        name: 'Nồi cơm điện',
        meta: 'Nhà cửa & Đời sống › Nhà bếp · MÃ DM-3305',
        col2: 'Cấp 3',
        col3: '212',
        ch: ['ok', 'ok', 'ok'],
        state: 'ready',
      ...
      row({
        name: 'Sữa bột cho bé',
        meta: 'Mẹ & Bé › Sữa & Thực phẩm · MÃ DM-4102',
        col2: 'Cấp 3',
        col3: '96',
        ch: ['ok', 'partial', 'ok'],
        state: 'partial',
        ...
        warning:
          'Lazada bắt buộc chứng nhận ATTP cho ngành hàng này. Bổ sung giấy tờ trước khi đăng.',
      }),
      row({
        name: 'Son môi',
        meta: 'Làm đẹp › Trang điểm › Môi · MÃ DM-5008',
        col2: 'Cấp 3',
        col3: '340',
        ch: ['ok', 'ok', 'partial'],
        state: 'partial',
      ...
      row({
        name: 'Giày sandal nữ',
        meta: 'Thời trang nữ › Giày dép · MÃ DM-2640',
        col2: 'Cấp 3',
        col3: '178',
        ch: ['none', 'none', 'none'],
        state: 'none',
      ...
      row({
        name: 'Bình giữ nhiệt',
        meta: 'Nhà cửa & Đời sống › Đồ dùng · MÃ DM-3390',
        col2: 'Cấp 3',
        col3: '64',
        ch: ['ok', 'none', 'ok'],
        state: 'partial',
  ...
  products: {
    ...
    rows: [
      row({
        thumb: 'NC',
        name: 'Nồi cơm điện Sunhouse SHD8602 1.8L',
        meta: 'SKU SH-NC8602 · Nhà cửa › Nhà bếp › Nồi cơm điện',
        col2: '1.290.000 ₫',
        col3: '184',
        ch: ['ok', 'ok', 'ok'],
        state: 'ready',
      ...
      row({
        thumb: 'SV',
        name: 'Sữa tươi tiệt trùng Vinamilk 1L (lốc 4)',
        meta: 'SKU VNM-ST1000-4 · Mẹ & Bé › Sữa',
        col2: '128.000 ₫',
        col3: '2.412',
        ch: ['ok', 'ok', 'ok'],
        state: 'ready',
        updated: '8 phút trước',
      }),
      row({
        thumb: 'AT',
        name: "Áo thun nam cotton co giãn Biti's",
        meta: 'SKU BTS-AT204 · Thời trang nam › Áo thun nam',
        col2: '249.000 ₫',
        col3: '0',
        ch: ['ok', 'broken', 'none'],
        state: 'error',
        tone: 'error',
        updated: 'Thất bại 12:04',
        warning:
          'Không đăng được sang Lazada: danh mục “Áo thun nam” đã hỏng ánh xạ. Tồn kho bằng 0 trên cả ba sàn.',
      }),
      row({
        thumb: 'SK',
        name: 'Son kem lì Cocoon Bí Đao 5ml',
        meta: 'SKU CCN-SK05 · Làm đẹp › Trang điểm › Môi',
        col2: '185.000 ₫',
        col3: '96',
        ch: ['ok', 'ok', 'partial'],
        state: 'partial',
      ...
      row({
        ...
        meta: 'SKU LL-BG500 · Nhà cửa › Đồ dùng',
        col2: '329.000 ₫',
        col3: '58',
        ch: ['ok', 'none', 'ok'],
        state: 'partial',
      ...
      row({
        ...
        meta: 'SKU TN-CF500 · Thực phẩm › Cà phê',
        col2: '165.000 ₫',
        col3: '740',
        ch: ['ok', 'ok', 'ok'],
        state: 'ready',
      ...
      row({
        thumb: 'GS',
        name: 'Giày sandal nữ quai chéo Vento',
        meta: 'SKU VT-GS118 · Thời trang nữ › Giày dép',
        col2: '459.000 ₫',
        col3: '26',
        ch: ['none', 'none', 'none'],
        state: 'none',
      ...
      row({
        thumb: 'MG',
        name: 'Máy lọc nước Kangaroo KG10G4 10 lõi',
        meta: 'SKU KG-10G4 · Gia dụng › Máy lọc nước',
        col2: '6.490.000 ₫',
        col3: '12',
        ch: ['ok', 'partial', 'none'],
        state: 'partial',
